// use crate::{libretro_types::*, Button, ButtonState, InputEvent};
...
//     static OUTPUT_SOUND_BUFFER: RefCell<[u8; 48000]> = RefCell::new([0; 48000]);
...
//                     let mut sound_buffer = video_output.borrow_mut();
//                     system.run_single_frame(
//                         &input_events,
//                         video_buffer.as_mut_slice(),
//                         sound_buffer.as_mut_slice(),
//                     );
